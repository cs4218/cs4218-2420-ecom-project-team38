    ...
    describe("Rendering of orders", () => {
      ...
      describe("Order details", () => {
        ...
        it("should render column headers for the order table", async () => {
          ...
          expect(
            await screen.findByRole("columnheader", { name: /buyer/i })
          ).toBeInTheDocument();
          expect(
            await screen.findByRole("columnheader", { name: /date/i })
          ).toBeInTheDocument();
          expect(
            await screen.findByRole("columnheader", { name: /payment/i })
          ).toBeInTheDocument();
          expect(
            await screen.findByRole("columnheader", { name: /quantity/i })
          ).toBeInTheDocument();
        });
